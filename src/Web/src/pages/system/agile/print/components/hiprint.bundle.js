...
var hiprint = function(t) {
    ...
    var y = function() {
        ...
        return t.prototype.insertRow = function(t, e, n) {
            ...
            }), this.rows.splice(p, 0, u), a.getTarget().before(u.getTarget()), r.a.event.trigger("newRow" + this.id, u);
            else {
                var d = p + o.rowspan - 1;
    ...
    var _r,
        ...
        l = function() {
            ...
            return t.prototype.createPrintElementTypeHtml = function(t, e) {
                var n = $('<div class="hiprint-printElement-type"></div>');
                return e.forEach(function(t) {
                    var e = $("<div></div>");
                    e.append('<span class="title">' + t.name + "</span>");
                    var i = $("<ul></ul>");
                    e.append(i), t.printElementTypes.forEach(function(t) {
                        i.append('<li><a class="ep-draggable-item" tid="' + t.tid + '" title="' + t.getText() + '">  ' + t.getText() + " </a></li>");
                    }), n.append(e);
        ...
        D = function(t) {
            ...
            return H(e, t), e.prototype.getDesignTarget = function(e) {
                ...
                var i = $('<div tabindex="1" class="hiprint-printElement hiprint-printElement-text" style="position: absolute;"><div class="hiprint-printElement-text-content hiprint-printElement-content" style="height:100%;width:100%;font-size: inherit;"></div></div>');
        ...
        pt = function() {
          ...
          `
                ...
                this.mouseRect.target || (this.mouseRect.target = $('<div tabindex="1" class="mouseRect" style="z-index:2;position: absolute;opacity:0.2;border: 1px dashed #000;background-color:#31676f;"><span></span></div>'), n.find(".hiprint-printPaper-content").append(this.mouseRect.target), this.bingKeyboardMoveEvent(this.mouseRect.target), this.mouseRect.target.hidraggable({
                    onDrag: function onDrag(t, n, i) {
                        e.mouseRect.lastLeft = e.mouseRect.lastLeft ? o.a.px.toPt(e.mouseRect.target[0].offsetLeft) : n / ptr, e.mouseRect.lastTop = e.mouseRect.lastTop ? o.a.px.toPt(e.mouseRect.target[0].offsetTop) : i / ptr, (e.mouseRect.mouseRectSelectedElement || []).forEach(function(t) {
        ...
        ut = function() {
            ...
            return t.prototype.init = function() {}, t.prototype.clearSettingContainer = function() {
                ...
                var o = [],
                    supportOptions = p.a.instance.panel.supportOptions.filter(function(t) {
                        return !t.hidden;
                    }).map(function(e) {
                        return e.name;
                    });
