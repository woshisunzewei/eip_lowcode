    ...
    <div style="width: 100%">
        ...
        <a-card class="eip-admin-card-small" :bordered="false">
            ...
            <vxe-table :loading="table.loading" id="formlist" ref="table" :seq-config="{
                ...
                <vxe-column field="orderNo" title="排序" align="center" width="80"></vxe-column>
                <vxe-column field="dataFrom" title="来源" align="center" width="80">
                    <template v-slot="{ row }">
                        <a-tag color="#f50" v-if="row.dataFrom == 0">
                            表
                        </a-tag>
                        <a-tag color="#2db7f5" v-else-if="row.dataFrom == 1">
                            视图
                        </a-tag>
                        <a-tag color="#87d068" v-else-if="row.dataFrom == 2">
                            存储过程
                        </a-tag>
                        <a-tag color="#87d068" v-else-if="row.dataFrom == 3">
                            接口
                        </a-tag>
                    </template>
                </vxe-column>
                <vxe-column field="dataFromName" title="来源名称" min-width="150" showOverflow="ellipsis"></vxe-column>
...
import {
    ...
    del,
    isFreeze,
} from "@/services/system/agile/print/list";
