 ...
 * @LastEditTime: 2021-05-27 15:18:39
 -->
<template>
  <a-modal v-drag title="代码" :footer="null" :visible="visible" @cancel="handleCancel"
    wrapClassName="code-modal-9136076486841527" style="top:20px;" width="850px" :destroyOnClose="true">
