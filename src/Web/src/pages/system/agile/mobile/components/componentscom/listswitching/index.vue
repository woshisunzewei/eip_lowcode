<template>
  <div class="listswitching" :ref="listSwitchName" :style="{ backgroundImage: 'url(' + datas.bgImg + ')' }">
    <!-- 没有视频展示默认 -->
    <!-- 类型一 -->
    <div class="more" v-show="datas.showMore && datas.commoditylisttype == 0"
      :style="{ 'margin-right': datas.pageMargin + 'px' }">
      更多》
    </div>
    <section v-show="!datas.imageList[0] && datas.commoditylisttype === 0" :class="[
  ...
  'border-radius': datas.borderRadius + 'px',
        ...
        <div class="bg-pic">
          ...
          <van-tag :color="datas.commodityTagColor || tagColor" :style="styleString" class="marks"
            v-show="datas.commoditycorner && datas.commoditycornertype === 1">热<br />卖</van-tag>
          <van-tag :color="datas.commodityTagColor || tagColor" :style="styleString" class="marks"
  ...
  'padding-right': datas.pageMargin + 'px',
      ...
      <div v-for="(item, index) in datas.imageList" :key="index" class="defaultcommodityList" :class="[
        datas.commodityType === 0 ? 'defaultcommodityList0' : '',
        datas.commodityType === 1 ? 'defaultcommodityList1' : '',
        datas.commodityType === 2 ? 'defaultcommodityList2' : '',
        datas.commodityType === 3 ? 'defaultcommodityList3' : '',
  ...
  'border-radius': datas.borderRadius + 'px',
        ...
        <div class="text" :style="{
          ...
          <div class="mony" v-if="datas.priceofcommodity || datas.purchasebutton">
            <span v-show="datas.priceofcommodity"><i>￥</i>
              {{ item.price }}
            </span>
            <div v-show="datas.purchasebutton">
              <van-icon name="cart-circle-o" size="23" v-show="datas.purchasebuttonType === 0" />
    ...
    <!-- 类型二 -->
    <div class="tab-type2">
      <div class="more" v-show="datas.showMore && datas.commoditylisttype == 1" :style="{
      ...
      <van-tabs v-model="active1" v-show="datas.commoditylisttype === 1" animated swipeable :color="datas.tabColor">
        <van-tab :name="index" :title="item.text" v-for="(item, index) in datas.commoditylisttypetab" :key="index" :style="{
          'font-size': item.wordSize + 'px',
          'font-weight': item.wordWeight,
        }">
          <section v-show="!item.imageList[0] && datas.commoditylisttype === 1"
  ...
  'border-radius': datas.borderRadius + 'px',
          ...
          <section v-show="item.imageList[0] && datas.commoditylisttype === 1"
            ...
            <div v-for="(item, index) in item.imageList" :key="index" class="defaultcommodityList" :class="[
              datas.commodityType === 0 ? 'defaultcommodityList0' : '',
              datas.commodityType === 1 ? 'defaultcommodityList1' : '',
              datas.commodityType === 2 ? 'defaultcommodityList2' : '',
              datas.commodityType === 3 ? 'defaultcommodityList3' : '',
  ...
  'border-radius': datas.borderRadius + 'px',
    ...
    <div>
      <div class="more" v-show="datas.showMore && datas.commoditylisttype == 2" :style="{
        'margin-right': datas.pageMargin + 'px',
        'margin-top': '0px',
      }">
        更多》
      </div>
      <van-tree-select height="auto" :items="datas.commoditylisttypetab" :main-active-index.sync="active"
        v-show="datas.commoditylisttype === 2" class="type3" @click-nav="treeSelect">
        <template #content>
          <div v-for="(item, index) in datas.commoditylisttypetab" :key="index">
            <section v-if="active === index" v-show="!item.imageList[0]" class="defaultcommodity" :style="{
              'padding-top': datas.commodityMargin + 'px',
              'padding-left': datas.pageMargin + 'px',
              'padding-right': datas.pageMargin + 'px',
            }">
            ...
            <section v-if="active === index" v-show="item.imageList[0]" class="defaultcommodity" :style="{
              ...
              <div v-for="(item, index) in item.imageList" :key="index" class="defaultcommodityList defaultcommodityList3"
                :style="{
                  border:
                    datas.moditystyle === 2
                      ? '1px solid rgba(50,50,51,0.1)'
