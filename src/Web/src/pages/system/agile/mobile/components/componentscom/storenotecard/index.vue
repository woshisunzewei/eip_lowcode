<template>
  <div class="storenotecard">
    ...
    <!-- 没有视频展示默认 -->
    <section v-show="!datas.imageList[0]" :class="[datas.commodityType === 2 ? 'defaultcommodityList2' : '']"
      class="defaultcommodity">
      <div v-for="index in 3" :key="index" class="defaultcommodityList" :class="[
  ...
  width:
    datas.commodityType === 1
      ...
      : datas.commodityType === 2
        ...
        <!-- 视频图片 -->
        <div class="imgss" style="position: relative; width: 100%"
        ...
        <div class="text" :class="[datas.positions === 'top' ? 'positionsTop' : '']"
          ...
          <div class="dianz">
            ...
            <span v-else></span>
            <span v-show="datas.praisePoints"><van-icon name="good-job-o" /> 999</span>
          </div>
        </div>
      </div>
    </section>
