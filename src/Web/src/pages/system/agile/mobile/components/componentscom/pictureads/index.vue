<template>
  <div class="pictureads">
    ...
    <!-- 一行一个 -->
    <div v-if="imageList[0] && swiperType === 0" class="type0" :style="{
      'padding-left': datas.pageMargin + 'px',
      'padding-right': datas.pageMargin + 'px'
    }">
      <div v-for="(item, index) in imageList" :key="index" class="imgLis"
    ...
    <!-- 轮播组件 -->
    <div class="swiper-container" v-if="(imageList[0] && swiperType === 1) ||
      swiperType === 2 ||
      swiperType === 3
      ">
      <div :class="swiperType === 3 && imageList[0]
