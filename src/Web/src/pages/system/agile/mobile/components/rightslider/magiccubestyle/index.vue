<template>
  <div class="magiccubestyle">
    ...
    <section class="buju buju0" v-show="datas.rubiksCubeType === 0">
      <div @click="imgActive = index - 1" v-for="index in 2" :key="index" class="rubiksCubeType0 rubiksCubeType"
    ...
    <section class="buju buju0" v-show="datas.rubiksCubeType === 1">
      <div @click="imgActive = index - 1" v-for="index in 3" :key="index" class="rubiksCubeType1 rubiksCubeType"
        :class="[index - 1 === imgActive ? 'active' : '']">
        <div style="font-size: 12px" v-if="!datas.imageList[index - 1].src">
          宽度250像素
        </div>
    ...
    <section class="buju buju0" v-show="datas.rubiksCubeType === 2">
      <div @click="imgActive = index - 1" v-for="index in 4" :key="index" class="rubiksCubeType2 rubiksCubeType"
        :class="[index - 1 === imgActive ? 'active' : '']">
        <div style="font-size: 12px" v-if="!datas.imageList[index - 1].src">
          宽度188像素
        </div>
    ...
    <section class="buju buju0" v-show="datas.rubiksCubeType === 3">
      <div @click="imgActive = index - 1" v-for="index in 4" :key="index" class="rubiksCubeType3 rubiksCubeType"
        :class="[index - 1 === imgActive ? 'active' : '']">
        <div style="font-size: 12px" v-if="!datas.imageList[index - 1].src">
          375x375像素<br />或同等比例
        </div>
    ...
    <section class="buju buju4" v-show="datas.rubiksCubeType === 4">
      <div @click="imgActive = 0" class="rubiksCubeType4 rubiksCubeType" style="width: 163px; height: 300px"
      ...
      <div style="display: inline-flex; flex-direction: column">
        <div @click="imgActive = index" class="rubiksCubeType4 rubiksCubeType"
          :class="[index === imgActive ? 'active' : '']" v-for="index in 2" :key="index">
    ...
    <section class="buju buju5" v-show="datas.rubiksCubeType === 5">
      <div @click="imgActive = 0" class="rubiksCubeType4 rubiksCubeType" style="width: 325px; height: 163px"
        :class="[0 === imgActive ? 'active' : '']">
        <div style="font-size: 12px" v-if="!datas.imageList[0].src">
          375x750像素<br />或同等比例
        </div>
    ...
    <section class="buju buju4" v-show="datas.rubiksCubeType === 6">
      <!-- 第一张图片 -->
      <div @click="imgActive = 0" class="rubiksCubeType4 rubiksCubeType" style="width: 163px; height: 325px"
        :class="[0 === imgActive ? 'active' : '']">
        <div style="font-size: 12px" v-if="!datas.imageList[0].src">
          375x750像素<br />或同等比例
        </div>
      ...
      <div style="display: inline-flex; flex-direction: column">
        ...
        <div class="rubiksCubeType4 rubiksCubeType">
          <div @click="imgActive = index + 1" :class="[index + 1 === imgActive ? 'active' : '']" style="
                                                                          display: inline-flex;
                                                                          width: 82px;
                                                                          height: 163px;
    ...
    <a-form :label-col="{ span: 5 }" :wrapper-col="{ span: 19 }" :model="datas">
      <section class="magiccubestyleList" v-for="(item, index) in datas.imageList" :key="index"
        ...
        <!-- 图片 -->
        <div class="imag" @click="upLoadimg.visible = true">
          <img draggable="false" v-if="!item.src" src="../../../assets/images/add.png" style="border: 1px solid #e5e5e5"
            alt="" />
        ...
        <div class="imgText">
          ...
          <!-- 输入链接 -->
          <a-input size="small" style="margin-top: 2px;" placeholder="请输入链接，输入前确保可以访问" v-model="item.http.externalLink">
          </a-input>
        </div>
      </section>
      ...
      <div class="rubiksCubeType">
        <a-tooltip class="item" :title="item.content" placement="bottom" v-for="(item, index) in rubiksCubeTypes"
          :key="index">
      ...
      <!-- 页面边距 -->
      <a-form-item label="页面边距" class="lef">
        <a-slider v-model="datas.pageMargin" :max="20"> </a-slider>
      </a-form-item>

      <!-- 图片间隙 -->
      <a-form-item label="图片间隙" class="lef">
        <a-slider v-model="datas.imgMargin" :max="20"> </a-slider>
      </a-form-item>
    </a-form>
