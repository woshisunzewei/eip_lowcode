...
componentProperties.set('captiontext', {
    ...
    setStyle: {
        ...
        wordColor: '#323334', //标题颜色
        descriptionColor: '#969799', //描述颜色
...
componentProperties.set('workflow', {
    component: 'workflow',
    text: '工作流',
    type: '2-4',
    active: true,
...
componentProperties.set('mobilemenu', {
