        ...
        <a-row>
          <a-col>
            ...
            <a-form-model-item label="内容">
              <eip-editor ref="dingTalkEditor" v-if="tinymce.show" v-model="form.content" :height="tinymce.height"
...
export default {
  name: "eip-workflow-notice-ding-talk",
  data() {
    return {
      tinymce: {
  ...
  methods: {
    ...
    contentOk(value) {
      ...
      this.$refs.dingTalkEditor.insertIndex(html, 0);
    },
    /**
     *内容选择点击
     */
    ...
    save() {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          that.form.contentTxt = that.$refs.dingTalkEditor.getTxt();
