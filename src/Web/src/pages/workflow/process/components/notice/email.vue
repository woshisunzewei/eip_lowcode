        ...
        <a-row>
          <a-col>
            ...
            <a-form-model-item label="内容">
              <eip-editor ref="emailEditor" v-if="tinymce.show" v-model="form.content" :height="tinymce.height"
...
export default {
  name: "eip-workflow-timeout-email",
  data() {
    return {
      tinymce: {
  ...
  methods: {
    ...
    contentOk(value) {
      ...
      this.$refs.emailEditor.insertIndex(html, 0);
    },
    ...
    save() {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          that.form.contentTxt = that.$refs.emailEditor.getTxt();
