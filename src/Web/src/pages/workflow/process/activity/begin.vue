<template>
  <a-modal v-drag :destroyOnClose="true" :maskClosable="false" width="1100px" :title="title" :visible="visible"
            ...
            <a-form-model ref="form" :model="base" :rules="rules" :label-col="config.labelCol"
              ...
              <a-row>
                <a-col>
                  ...
                  <a-form-model-item label="标题" prop="titleRule">
                    <span class="ant-input-group-wrapper"><span class="ant-input-wrapper ant-input-group">
                        <div class="ant-input" v-html="base.titleRule"></div>
                        <span class="ant-input-group-addon"> <a-icon @click="titleRuleClick" type="setting" /></span>
                      </span>
                    </span>
                  </a-form-model-item>
    ...
    <eip-workflow-title-rule ref="titleRule" v-if="titleRule.visible" :visible.sync="titleRule.visible"
      :edit="titleRule.value" :column="column.data" title="标题规则" @ok="titleRuleOk"></eip-workflow-title-rule>
...
import eipWorkflowTitleRule from "../components/titlerule/index";
