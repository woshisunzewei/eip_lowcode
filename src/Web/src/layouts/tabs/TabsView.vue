<template>
  <admin-layout>
    ...
    <div
      ...
      :style="`margin-top: ${multiPage ? -24 : -38}px`"
    >
...
export default {
  ...
  methods: {
    ...
    remove(key, next) {
      ...
      Cookie.remove("AgileListSearchCache");
    },
    refresh(key, page) {
    ...
    createPage(route) {
      ...
      return {
        ...
        count: route.meta && route.meta.count,
        title: title
          ? title
          : route.meta && route.meta.page && route.meta.page.title,
        unclose:
