<template>
  <a-modal v-drag centered :destroyOnClose="true" :maskClosable="false" :bodyStyle="{ padding: '1px' }" :zIndex="1004"
    title="表达式配置" :width="modalWidth" :visible="visible" @ok="handleSubmit" @cancel="close">
    <div>
      <a-tabs>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      this.$emit('ok', this.crontabValueString)
      this.close()
      this.visible = false
    },
    shouldHide(key) {
