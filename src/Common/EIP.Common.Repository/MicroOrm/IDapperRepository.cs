...
namespace EIP.Common.Repository.MicroOrm
{
    ...
    public partial interface IDapperRepository<TEntity> : IReadOnlyDapperRepository<TEntity> where TEntity : class
    {
        ...
        ///     Update object in DB
        /// </summary>
        bool Update(Expression<Func<TEntity, bool>> predicate, object setPropertyObj);

        /// <summary>
        ///     Update object in DB
        /// </summary>
        Task<bool> UpdateAsync(Expression<Func<TEntity, bool>> predicate, object setPropertyObj);

        /// <summary>
        ///     Update object in DB
        /// </summary>
        Task<bool> UpdateAsync(Expression<Func<TEntity, bool>> predicate, Dictionary<string, object> setPropertyDict);
        #endregion
    }
}
