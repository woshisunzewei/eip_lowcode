...
namespace EIP.Common.Repository.MicroOrm
{
        ...
        where TEntity : class
    {
        ...
        {
            return Delete(predicate, transaction, null);
        }

        public virtual bool Delete(TEntity instance, IDbTransaction transaction = null)
        {
            return Delete(instance, transaction, null);
        }
        public virtual Task<bool> DeleteAsync(TEntity instance, IDbTransaction transaction = null)
        {
            return DeleteAsync(instance, transaction, null, default);
        }
        public virtual Task<bool> DeleteAsync(Expression<Func<TEntity, bool>> predicate, IDbTransaction transaction = null, TimeSpan? timeout = null)
        {
            return DeleteAsync(predicate, transaction, timeout, default);
        }

        public virtual Task<bool> DeleteAsync(Expression<Func<TEntity, bool>> predicate)
        {
            return DeleteAsync(predicate, null, null, default);
        }
        #endregion
    }
}
